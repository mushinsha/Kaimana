...
//OVERDRIVES
  //Megalomania              [632146 + HS]
  //Ultimate Fortissimo      [632146 + S] (In Air Possible)
  
//SPECIAL MOVES
  //Antidepressant Scale     [214 + P] (In Air Possible)
  //Chemical Love            [214 + K] (In Air Possible)
  //Mad Love Agitato         [214 + S]
  //Stroke the Big Tree      [236 + S or HS]
  //Sultry Performance       [236 + K or S or HS] (In Air Only and can be held)
